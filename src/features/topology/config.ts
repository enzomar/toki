...
export const WORKSPACE_SAMPLES: Array<{
  ...
  },
  {
    ...
    description: 'An orchestrator delegates to specialized agents: a Summary agent with MCP calls for data retrieval, and a General Creator with MCP calls for content generation.',
    ...
    agents: [
      ...
      },
      {
        ...
        ragEmbeddingTokens: 0,
        mcpCalls: 2,
        mcpTokensPerCall: 180,
        routingMode: 'weighted',
      },
    ],
    edges: [
      { id: 'ae1', sourceId: 'audience-orch', targetId: 'summary-agent', weight: 0.5 },
      { id: 'ae2', sourceId: 'audience-orch', targetId: 'creator-agent', weight: 0.5 },
    ],
  },
]
